...
@click.option('-type', 't', type=click.Choice(['gff', 'gtf']), default='gff',
...
def run(in_file, t, utr_color, utr_hatch, cds_color, cds_hatch, exon_color, exon_hatch, edge_color,
    ...
    if t == 'gff':
        ...
        if utr_color != 'salmon' or utr_hatch or cds_color != 'skyblue' or cds_hatch:
            click.echo('\033[33mThere are conflicting options, ignore "utr_color", "utr_hatch", "cds_color" and "cds_hatch".\033[0m')
