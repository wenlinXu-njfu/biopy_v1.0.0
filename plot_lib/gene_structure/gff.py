...
def plot_mRNA_structure(gff_file: str, utr_color: str, cds_color: str, figure_width: float, figure_height: float,
                        edge_color: str = None, out_path: str = None, out_prefix: str = 'mRNA_structure',
                        out_suffix: str = 'pdf',
    ...
    # Set legend
    plt.legend([utr, cds, intron], ['UTR', 'CDS', 'intron'], labelcolor='g', shadow=True, loc=3, bbox_to_anchor=(0.99, 0.99))
    # Save figure
    if out_path:
