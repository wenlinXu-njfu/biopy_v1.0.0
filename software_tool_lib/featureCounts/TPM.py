...
def get_TPM(featureCounts_result_file: str, out_file_prefix: str = 'TPM', min_value: float = None) -> None:
    """
    ...
    TPM.to_excel(f'./{out_file_prefix}.xlsx')
...
@click.option('-out', default='TPM', help='[optional] Output file prefix. {default=TPM}')
