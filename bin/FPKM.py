...
def get_FPKM(featureCounts_result_file: str, out_file: str, min_value: float = None) -> None:
    """
        ...
        :param featureCounts_result_file: gene expression matrix file (TAB delimiters).
        ...
        :return: None
        """
    df = pd.read_table(featureCounts_result_file, index_col=0)
...
@click.option('-in', 'exp', help=f"""Gene expression matrix file. (TAB delimiters)
                                 \033[33m\n{file_content}\033[0m""")
